...
class PDVcreate(BaseModel):
    ...
    active: bool = Field(default=True, description="Indicates if the PDV is active")
    company_id: Optional[UUID] = Field(None, description="ID of the company that owns the PDV")
...
class PDVUpdate(BaseModel):
    ...
    active: Optional[bool] = Field(None, description="Indicates if the PDV is active")
